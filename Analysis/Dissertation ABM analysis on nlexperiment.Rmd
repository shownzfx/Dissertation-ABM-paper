...
data1Run<-dataRun %>% filter(adaptNum >=30) %>% mutate(missedRatio=windowMissed/windowoOpen,insufRatio=insufBoost/windowoOpen,disasterRatio=disasterWindows/windowoOpen)

data1Run

data_long<-gather(data1Run,key="paramName",value="paramValue", c("windowoOpen","capBoost","noSolution","disasterWindows","missedRatio","insufRatio","disasterRatio"))
