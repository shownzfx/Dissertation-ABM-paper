...
to import-orgs
  ...
  [
    ...
    create-orgs  1 [
      ...
      set ewThreshold  item (ceiling 2400 * extremeWeatherProb) weatherSeverityExp
...
to take-impact
  ...
  ifelse sol-efficacy * resilience >= weatherSeverity ; impact is jointly decided by efficacy of org solution and weather severity
  [set impactPerTick 0]
