...
;    if weatherSeverity > expectedBadWeatherSeverity [set expectedBadWeatherSeverity weatherSeverity]
    ...
    [set expectedEWProb expectedEWProb * (1 - (random-float 0.02))] ; extremeweatherevent did not happen, then expectedprob decrease
    [
...
to expect-impact
  ask orgs [
    ...
    if expectedImpact < 0 [set expectedImpact 0]
