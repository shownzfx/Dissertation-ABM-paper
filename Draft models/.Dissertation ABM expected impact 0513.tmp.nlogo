...
to import-orgs
  ...
  [
    ...
    create-orgs  1 [
      ...
      set disasterProb disasterProb + random-float 0.01
...
to assess-thruNetwork
  ...
  let knownSolutions1 (solutions-on scanningPatches) with [adaptation? and efficacy > currentSolEfficacy]
  let knownSolutions2 [current-solution] of org-sameReg-link-neighbors

  let knownSolutions (turtle-set knownSolutions1 knownSolutions2)
